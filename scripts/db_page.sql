...
CREATE TABLE `pages_uri` (
  ...
  KEY `idx_uri` (`uri`)
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='页面URI表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES ('admin','管理员','管理员权限，不能打开页面，只能使用接口'),('default','普通用户','普通用户权限，需要分配具体页面权限'),('system','系统管理员','系统最高权限，拥有所有功能的完全访问权限');
